...
|android_extra_components_pip_executable|Specified path of pip to install python libraries which is needed to install `android_extra_components` automatically. <br> If it isn't defined, pip which Ansible finds automatically is used.|str|Not defined in default.|
